...
reached, len_quantity = 0, len(quantity)
...
if reached < len_quantity:
    print(f"John did not reach: Altitude {len_quantity - len(quantity)}")
if reached and reached < len_quantity:
